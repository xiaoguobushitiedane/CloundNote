...
select * from cn_activity_status;

DELETE FROM cn_user WHERE cn_user_name='luowei'

DELETE FROM cn_note_activity WHERE cn_note_activity_id='054449b4-93d4-4f97-91cb-e0043fc4497f'

8c9fe314-6163-4e7e-9162-7b7a00adac69
ooooo ssss fdfdfdfdfdf rrrrrrrrrrrrrrrrrr


DELETE FROM cn_note WHERE cn_note_title='剑圣'

select * from cn_note_activity where  cn_activity_id='1'


select * from cn_note where  cn_note_id='9971724f-e890-429b-8ffc-a52eb73e59a4'

select * from cn_share where  cn_note_id='4978fa2d-f7de-4b8b-b496-79071d053cb4'and cn_share_id='88e6977b-fa60-4d8e-a33a-6a4a4ce00401'  
DELETE FROM cn_share WHERE cn_share_title='剑圣'


select * from cn_note_activity where cn_note_activity_id='0d34fc17-ceab-40ae-bd07-edccd6c2ef8b'

update cn_note_activity set cn_activity_id=11 
where cn_note_activity_id='5595e8c9-df35-4e91-8e8c-a3af3a0c3de3'
...
insert into cn_notebook values(
	'b1','0c395149-b749-43cb-8d34-a89a67e5ff2a','5','JAVA','null','2014-06-27 15:18:59.0'

);

insert into cn_notebook values(
	'b2','0c395149-b749-43cb-8d34-a89a67e5ff2a','5','JAVA EE','null','2014-06-27 15:18:59.0'

);

insert into cn_notebook values(
	'b3','0c395149-b749-43cb-8d34-a89a67e5ff2a','5','JAVA SE','null','2014-06-27 15:18:59.0'

);
insert into cn_notebook values(
	'b4','0c395149-b749-43cb-8d34-a89a67e5ff2a','5','JAVA SS','null','2014-06-27 15:18:59.0'

);
insert into cn_notebook values(
	'b5','0c395149-b749-43cb-8d34-a89a67e5ff2a','5','JAVA WEB','null','2014-06-27 15:18:59.0'
...
DELETE FROM cn_notebook WHERE cn_user_id=9;
-- ----------------------------
