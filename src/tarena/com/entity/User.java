...
public class User implements Serializable{
	...
	private static final long serialVersionUID = -6346327242562065938L;
 ...
 * @param cn_user_desc
 */
public User(String cn_user_id, String cn_user_name, String cn_user_password,
		String cn_user_token, String cn_user_desc) {
	super();
	this.cn_user_id = cn_user_id;
	this.cn_user_name = cn_user_name;
	this.cn_user_password = cn_user_password;
...
public String toString() {
	return "User [cn_user_id=" + cn_user_id + ", cn_user_name=" + cn_user_name
			...
			+ cn_user_token + ", cn_user_desc=" + cn_user_desc + "]";
}
